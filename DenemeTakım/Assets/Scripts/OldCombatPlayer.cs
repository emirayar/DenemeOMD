...
public class CombatPlayer : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            Debug.LogError("Düþman nesnesi bulunamadý.");
        }
    }
    ...
    void Attack()
    {
        ...
        // Oyuncunun yeni pozisyonunu hesaplayýn.
        ...
        // Combo zamanlayýcýsýný baþlatýn ve combo'yu etkin olarak iþaretleyin.
    ...
    void Attack2()
    {
        // Düþmanýn pozisyonunu belirleyin (bu referansý ayarlamanýz gerekir).
        Vector3 enemyPosition = enemyTransform.position;
